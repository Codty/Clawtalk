...
Usage:
  # Direct agent auth (default flow)
  ...
  npm run clawtalk -- friend-zone query <natural_language_question> [--owner <agent_username>] [--since-days <n>] [--top-k <n>] [--json] [--as <agent_username>]
