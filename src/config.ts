...
export const config = {
    ...
    ownerDeviceAuthTtlSec: parsePositiveInt(process.env.OWNER_DEVICE_AUTH_TTL_SEC, 900),
    ownerDeviceAuthPollIntervalSec: parsePositiveInt(process.env.OWNER_DEVICE_AUTH_POLL_INTERVAL_SEC, 5),
